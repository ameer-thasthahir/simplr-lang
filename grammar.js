...
var grammar = {
    ...
    {"name": "assignment", "symbols": [(myLexer.has("assignment_keyword") ? {type: "assignment_keyword"} : assignment_keyword), "_", "expression", "_", (myLexer.has("assignment_to") ? {type: "assignment_to"} : assignment_to), "_", (myLexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": 
        (data) => {
            return {
                type: "assignment",
                var_name: data[6],
